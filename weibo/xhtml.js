...
class xhtml{
   constructor(x){
    ...
    static firstblood(text){
        ...
        // let contentDom = $('body').children().text()
        const contentDom = text
        console.log('content -----------------')
        console.log(text.slice(4000, 5500))

        // contentDom = contentDom

        // contentDom.each(function(i, elem) {
        //     const name = $('.name', this).text();
        //     // console.log('------------------start-------------')
        //     // console.log(name)
        //     const content = $('.txt', this).last().text().trim()
        //     // console.log(content)
        //     // console.log('------------------end-------------')
        ...
        //       obj.name = name
        //       obj.content = content
        //       obj.time = $('.from', this).children().first().text().trim().slice(0,12)
